      ...
      g = {
        ...
        show: function (t) {
          ...
          if (
            ...
            (!c || d || o.templates.dropdownItemNoMatch) &&
              !1 !== o.dropdown.enable &&
          ...
          callbacks: {
            onKeyDown: function (t) {
              var e = this.DOM.dropdown.querySelector(
                  "." + this.settings.classNames.dropdownItemActive
                ),
                i = e;
              switch (t.key) {
                case "ArrowDown":
                ...
                case "Tab":
                  if (
                    ...
                    return (
                      this.input.autocomplete.set.call(this, n.value || n), !1
                    );
                  }
                  return !0;
                case "Enter":
              ...
              if (0 == t.button && t.target != this.DOM.dropdown) {
                ...
                (this.state.actions.selectOption = !0),
                  ...
                  this.settings.hooks
                    ...
                    .then(function () {
                      i
                        ? e.dropdown.selectOption.call(e, i)
        ...
        selectOption: function (t) {
          ...
          if (!t)
            return (
              ...
              void (a && this.dropdown.hide.call(this))
            );
          ...
          if ((this.trigger("dropdown:select", { data: o, elm: t }), n && o)) {
            if (
              (this.state.editing
                ? this.onEditTagDone(null, d({ __isValid: !0 }, o))
          ...
          return d([], t)
            .map(function (t, i) {
              ...
              return (n = n
                ...
                .replace(">", ' tagifySuggestionIdx="'.concat(i, '">')));
            })
            .join("");
        },
      },
            ...
            if (
              ...
              if ("focus" == s)
                return (
                  ...
                  void (
                    0 === i.dropdown.enabled && this.dropdown.show.call(this)
                  )
                );
              "blur" == s &&
                (this.trigger("blur", n),
        ...
        onKeydown: function (t) {
                ...
                this.isFirefox &&
                  ...
                  setTimeout(function () {
                    ...
                    if (
                      ...
                      return (
                        (e.DOM.input.innerHTML = ""), (e.value.length = 0), !0
                      );
                    e.value = [].map
                      .call(g, function (t, i) {
                        var s = e.tagData(t);
          ...
          switch (t.key) {
            ...
            case "ArrowRight":
              ...
              if (u && this.settings.autoComplete.rightKey)
                return void this.addTags([u], !0);
              break;
            case "Tab":
              if (
                (i && t.preventDefault(), !i || "select" == this.settings.mode)
              )
                return !0;
            case "Enter":
        ...
        onMixTagsInput: function (t) {
          ...
          if (
            ...
            this.value.slice().forEach(function (t) {
              t.readonly &&
                !v.includes(t.value) &&
                f.appendChild(c.createTagElem(t));
            }),
            f.childNodes.length &&
              (m.insertNode(f), this.setRangeAtStartEnd(!1, f.lastChild)),
            p.length != u)
          )
            return (
          ...
          setTimeout(function () {
            c.update({ withoutChangeEvent: !0 }),
              ...
              c.state.tag &&
                c.dropdown[n ? "show" : "hide"].call(c, c.state.tag.value);
          }, 10);
        },
        ...
        onEditTagInput: function (t, i) {
          ...
          r || !0 !== t.originalIsValid || (l = !0),
            ...
            o.length >= this.settings.dropdown.enabled &&
              ...
              this.dropdown.show.call(this, o)),
          ...
          if (
            ...
            if (o)
              if (l) {
                if (
                  ((s =
                    this.getWhitelistItem(o) ||
                    (e((i = {}), a.tagTextProp, o), e(i, "value", o), i)),
                  a.transformTag.call(this, s, r),
                  !0 !==
                    (d = this.validateTag(
                      e({}, a.tagTextProp, s[a.tagTextProp])
                    )))
                ) {
                  if (
                    (this.trigger("invalid", { data: s, tag: n, message: d }),
        ...
        isTagDuplicate: function (t, e) {
          ...
          return (
            ...
            this.value.reduce(function (n, o) {
              return s(i.trim("" + t), o.value, e || a.dropdown.caseSensitive)
                ? n + 1
                : n;
            }, 0)
          );
        ...
        getTagIndexByValue: function (t) {
          ...
          return (
            this.getTagElms().forEach(function (a, n) {
              s(e.trim(a.textContent), t, e.settings.dropdown.caseSensitive) &&
                i.push(n);
            }),
            i
          );
            ...
            h &&
              (t.forEach(function (t) {
                ...
                a && a instanceof Object
                  ...
                  : "mix" == r ||
                    d ||
                    (null == t.value && (t.value = t[l]), c.push(t));
              }),
              (t = c)),
            t
          );
            ...
            (t = t
              ...
              .map(function (t, i) {
                ...
                if (
                  f ||
                  !(u.length > 1) ||
                  (o && !e.isTagWhitelisted(h.value)) ||
                  (!a && e.isTagDuplicate(h.value))
                ) {
