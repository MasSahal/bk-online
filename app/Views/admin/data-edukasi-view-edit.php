        ...
        <div class="row">
            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                <div class="box-content notika-shadow mg-tb-30">
                    <form action="<?= base_url() ?>/proses/edit-data-edukasi" method="post">
                        <div class="form-example-int form-horizental">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-10 col-md-7 col-sm-7 col-xs-12">
                                        <div class="nk-int-st">
                                            <input type="hidden" name="id" value="<?= $edukasi->id ?>" required>
                                            <input type="text" class="form-control" name="judul" placeholder="Judul Materi" value="<?= $edukasi->judul ?>" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-10 col-md-7 col-sm-7 col-xs-12">
                                        <div class="nk-int-st">
                                            <input type="text" class="form-control" name="link_video" placeholder="Link Youtube" value="<?= $edukasi->link_video ?>" required>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-10 col-md-7 col-sm-7 col-xs-12">
                                        <div class="nk-int-st">
                                            <textarea name="deskripsi" class="form-control auto-size" placeholder="Masukan deskripsi materi" rows="10" required><?= $edukasi->deskripsi ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
