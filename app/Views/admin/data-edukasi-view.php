                ...
                <div class="right-bar notika-shadow mg-tb-30 sm-res-mg-t-0">
                    <div class="inbox-left-sd">
                        ...
                        <div class="inbox-status">
                            ...
                            <hr>
                            <ul class="inbox-st-nav">
                                <li><a href="<?= base_url('/admin/data-edukasi-view-edit/' . $edukasi->id) ?>"><i class="notika-icon notika-draft"></i> Edit</a></li>
                                <li><a href="#" data-toggle="modal" data-target="delete_<?= $edukasi->id ?>"><i class="notika-icon notika-trash"></i> Hapus</a></li>
                            </ul>
                        </div>
                        <hr>
                        <div class="inbox-status">
