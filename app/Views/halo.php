...
<head>
    ...
    <title>Dashboard | BK Online</title>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        ...
                        <li><a data-toggle="tab" href="#mailbox"><i class="notika-icon notika-edit"></i> Program</a>
                        </li>
                        <li><a data-toggle="tab" href="#Page"><i class="notika-icon notika-support"></i> Profile</a>
                        </li>
                        <li><a data-toggle="tab" href="#Interface"><i class="notika-icon notika-app"></i> Lainnya</a>
                        </li>
