...
<body onload="startTime()">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
          <div class="logo-area">
            <a href="<?= base_url("/siswa/dashboard") ?>"><img src="<?= base_url("") ?>/assets/img/logo/logo.png" alt="" /></a>
          </div>
        </div>
              ...
              <ul class="mobile-menu-nav">
                <li><a data-toggle="collapse" data-target="#Charts" href="#">Home</a>
                  <ul class="collapse dropdown-header-top">
                    <li><a href="<?= base_url("") ?>/siswa/dashboard">Dashboard</a>
                    </li>
                    <li><a href="<?= base_url("") ?>/siswa/edukasi">Edukasi</a>
                    </li>
                    <li><a href="#" class="construction">Layanan Klasikal</a>
                    </li>
                  </ul>
                </li>
                <li><a data-toggle="collapse" data-target="#demoevent" href="#">Program</a>
                  <ul id="demoevent" class="collapse dropdown-header-top">
                    <li><a href="<?= base_url("") ?>/siswa/konsultasi">Konsultasi</a>
                    </li>
                    <li><a href="<?= base_url("") ?>/siswa/pengaduan">Pengaduan</a>
                    </li>
                    <li><a href="<?= base_url("") ?>/siswa/jenis-pelanggaran">Jenis Pelanggaran</a>
                    </li>
                    <li><a href="<?= base_url("") ?>/siswa/riwayat-pelanggaran">Pengetahuan</a>
                    </li>
                  </ul>
                </li>
                <li><a data-toggle="collapse" data-target="#democrou" href="#">Profile</a>
                  <ul id="democrou" class="collapse dropdown-header-top">
                    <li><a href="<?= base_url("") ?>/siswa/profile-saya">Profil Saya</a>
                    </li>
                    <li><a href="<?= base_url("") ?>/siswa/profile-siswa">Profil Siswa</a>
                    </li>
                  </ul>
                </li>
                <li><a data-toggle="collapse" data-target="#Pagemob" href="#">Lainnya</a>
                  <ul id="Pagemob" class="collapse dropdown-header-top">
                    <li><a href="<?= base_url("") ?>/siswa/about">About</a>
                    </li>
                    <li><a href="<?= base_url("") ?>/siswa/faq">FAQ</a>
                    </li>
                  </ul>
                </li>
              </ul>
          ...
          <div class="tab-content custom-menu-content">
            <div id="Home" class="<?php if ($active == "Home") : echo "active ";
              ...
              <ul class="notika-main-menu-dropdown">
                ...
                <li>
                  <!-- <a href="<?= base_url("") ?>/siswa/layanan-klasikal">Layanan Klasikal</a> -->
            ...
            <div id="Program" class="<?php if ($active == "Program") : echo "active ";
              ...
              <ul class="notika-main-menu-dropdown">
                ...
                <li><a href="<?= base_url("") ?>/siswa/riwayat-pelanggaran">Riwayat Pelanggaran</a>
                </li>
              </ul>
            </div>
  ...
  <script>
    ...
    function checkTime(i) {
      if (i < 10) {
        i = "0" + i
      }; // add zero in front of numbers <script 10 return i; } < />
      return i;
    };
  </script>
  <script>
